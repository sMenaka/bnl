...
<%@page import="org.birdnestlanka.db.GetBirdFamily"%>
<%@page import="org.birdnestlanka.beans.BirdFamily"%>
				...
				<col width="400">
					<tr>
						<th bgcolor="#000000"><center>
								<font size="3px" color="#ffffff">Family Name</font>
							</center></th>
							<th bgcolor="#000000"><center>
								<font size="3px" color="#ffffff">Description</font>
							</center></th>
					</tr>
					...
					<%
						GetBirdFamily bdf = new GetBirdFamily();
						List<BirdFamily> list = bdf.getFamilyList(val);
						System.out.println(val);
						for (BirdFamily f : list) {
					%>
					<tr>

						<td bgcolor="#dedede"><a
								href=<%="\"SpeciesForDes.jsp?name=" + f.getFamilyID() + "\""%>><font size="3px" color="#000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=f.getFamilyName()%></font></a></td>
					<td bgcolor="#dedede"><a
								href=<%="\"SpeciesForDes.jsp?name=" + f.getFamilyID() + "\""%>><font size="3px" color="#000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=f.getDes() %></font></a></td>
					</tr>
					<%
						}
					%>
