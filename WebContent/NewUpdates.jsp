		...
		<div class="col-sm-7"
				...
				<col width="500">
					<tr>
						...
						<th bgcolor="#000000"><center>
								<font color="#ffffff" size="3px">Common Name</font>
							</center></th>
					</tr>
					...
					<%
						...
						List<Bird> BirdList = bird.getBird();
					...
					<tr>
						<td bgcolor=" #dedede">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
								href=<%="\"NewImages.jsp?name=" + lbird.getId() +"-"+"0"+ "\""%>><font color="#000000" size="3px"><%=lbird.getCommon_Name() %></font></a></td>
					</tr>
					<%
						c=c+1;
						}
						
						int y=BirdList.size()/20;
			...
			<% int x=0;
					while(x<y){
						...
						x=x+1;
						%>
						<a href=<%="\"NewUpdates.jsp?name="+x*20+"\"" %>><font size="4px" color="#ffffff"><%=x %></font></a>&nbsp;
					<% 
					}
