			...
			<table>
				...
				<col width="400">
					...
					<tr>
						...
						<td bgcolor="#dedede"><a
								href=<%="\"Speciessou.jsp?name=" + f.getFamilyID() + "\""%>><font size="3px" color="#000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=f.getFamilyName()%></font></a></td>
					<td bgcolor="#dedede"><a
								href=<%="\"Speciessou.jsp?name=" + f.getFamilyID() + "\""%>><font size="3px" color="#000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=f.getDes() %></font></a></td>
					</tr>
					<%
						}
					%>
