	...
	<div class="row">
		<div class="col-sm-2"
			...
			<form class="navbar-form" role="search" action="BirdList.jsp">
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Seach Image"
						name="q" list="spList">
					...
					<td bgcolor="#014712">
						<ul>
							...
							<li><a href=<%="\"NewUpdates.jsp?name=" + 20 + "\""%>><font
									size="4px" color=" #ffffff "><b>Latest Contributions</b></font></a></li>
							<br>
		...
		<%
			Bird blist = null;
				...
				List<Bird> list = getbird.getBird(val);
				if (item >= 0 && list.size() - 1 >= item) {
					blist = list.get(item);
				} else {
					blist = list.get(0);
					item = 0;
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<center>
							...
							<img src="<%=url%>" width="70%" height="auto" class="img-rounded" />
						</center>
						<br>
						<center>
							<table BORDER="2" BORDERCOLOR="#ffffff">
								...
								<col width="600">
								<tr>
									<td bgcolor="#522f2f"><font color="#ffffff">&nbsp;Common
											Name</font></td>
									<td bgcolor=" #e1e1e1">&nbsp;<%=blist.getCommon_Name()%></td>
								</tr>
								<tr>
									<td bgcolor="#522f2f"><font color="#ffffff">&nbsp;Species
											Name</font></td>
									<td bgcolor=" #e1e1e1">&nbsp;<%=blist.getSpecies()%></td>
								</tr>
								<tr>
									<td bgcolor="#522f2f"><font color="#ffffff">&nbsp;Other
											Names</font></td>
									<td bgcolor=" #e1e1e1">&nbsp;<%=blist.getOther_Name()%></td>
								</tr>
								<tr>
									<td bgcolor="#522f2f"><font color="#ffffff">&nbsp;Bird
											Group</font></td>
								...
								<tr>
									<td bgcolor="#522f2f"><font color="#ffffff">&nbsp;Bird
											Family</font></td>
									<td bgcolor=" #e1e1e1">&nbsp;<%=blist.getFamily()%></td>
								</tr>
								<tr>
						...
						<center>
							<table BORDER="2" BORDERCOLOR="#ffffff">
								...
								<col width="600">
								<tr>
									<td bgcolor="#9b3838"><font color="#ffffff">&nbsp;Photographer</font>
									</td>
									<td bgcolor=" #e1e1e1"><%=PhotoGrapher%></td>
								</tr>
								<tr>
									<td bgcolor="#9b3838"><font color="#ffffff">&nbsp;Email</font>
									</td>
									<td bgcolor=" #e1e1e1"><%=Email%></td>
								</tr>
								<tr>
									<td bgcolor="#9b3838"><font color="#ffffff">&nbsp;Date</font>
									</td>
									<td bgcolor=" #e1e1e1">&nbsp;<%=blist.getDate()%></td>
								</tr>
								<tr>
									<td bgcolor="#9b3838"><font color="#ffffff">&nbsp;Location</font>
									</td>
									<td bgcolor=" #e1e1e1">&nbsp;<%=blist.getLocation()%></td>
								</tr>
								<tr>
									<td bgcolor="#9b3838"><font color="#ffffff">&nbsp;Equipments</font>
									</td>
							...
							<form name="login" method="post">
								...
								<label>Enter to password edit and delete</label>&nbsp;
								
									<input type="password" class="form-control" name="pass" />&nbsp;
									<br> <input type="submit" class="btn btn-default"
										onclick="check(this.form)" id="pb" value="Login" />
							...
							<script language="javascript">
								...
								{		/*the following code checkes whether the entered userid and password are matching*/
									if (form.pass.value == "birdnest") {
										 window.open('Edit.jsp?val='+<%=blist.getId() %>);
									} else {
		...
		<div class="col-md-3"
			style="background-color: #014712; height: 1300px;"></div>
	</div>
</body>
</html>
>
