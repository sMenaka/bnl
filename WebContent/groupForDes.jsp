				...
				<col width="350">
					...
					<tr>
						<td bgcolor=" #dedede">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;<a
									href=<%="\"FamilyForDes.jsp?name=" + bg.getGroupID() + "\""%>><font size="2px" color="#000000"><%=bg.getGroupName()%></font></a>
							</td>
							<td bgcolor=" #dedede"><a
									href=<%="\"FamilyForDes.jsp?name=" + bg.getGroupID() + "\""%>><font size="2px" color="#000000"><%=bg.getDes() %></font></a></td>
					</tr>
					<%
						}
					%>
