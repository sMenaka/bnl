...
<body>
 ...
 %>
 	...
 	List<Photographer> photoList = photo.getPhotographerList();
 	for (Photographer pgl : photoList) {
 %>
			...
			<div class="panel-group">
				<div class="panel panel-default">
					<div class="panel panel-heading">
						<center>Upload Bird Image</center>
					</div>
							...
							<form method="post" action="uploadFile"
								...
								<table BORDER="3" BORDERCOLOR="#7e7e7e">
									...
									<tr>
										...
										<td colspan="3"><textarea name="other" rows="6" cols="49"></textarea></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="equip" size="50"></td>
									</tr>
									<tr>
										<td><label>Photographer</label></td>
										<td colspan="3"><input type="text" name="photographer"
											size="50" list="pgList"></td>
									</tr>
									<tr>
										<td><label>Date</label></td>
										<td colspan="3"><input type="text" name="Year" size="4"
											placeholder="Year"> <input type="text" name="month"
											size="2" placeholder="Month"> <input type="text"
											name="date" size="2" placeholder="Date"></td>
									</tr>
									<tr>
