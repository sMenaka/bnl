	...
	<div class="row">
		...
		<table>
			...
			Bird blist=null;
				...
				List<Bird> list = getbird.getBirdSpesicesPGID(Sp_ID);
			...
			<div class="panel-group">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<col width="100">
						<col width="650">
						<tr><td><a href=<%="\"PGImages.jsp?name=" + Sp_ID +"-"+Integer.toString(item-1)+ "\""%>> << previous </a></td>
						<td align="right"><a href=<%="\"PGImages.jsp?name=" + Sp_ID +"-"+Integer.toString(item+1)+ "\""%>>Next >></a></td></tr>
						</table>
						<center>

							<img src="<%=url%>" class="img-rounded" width="70%" height="auto" />
						</center>
						<br>
						<center>
