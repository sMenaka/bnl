			...
			<div class="panel-group">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<col width="100">
						<col width="650">
						<tr><td><a href=<%="\"limage.jsp?name=" + Sp_ID +"-"+Integer.toString(item-1)+ "\""%>> << previous </a></td>
						<td align="right"><a href=<%="\"limage.jsp?name=" + Sp_ID +"-"+Integer.toString(item+1)+ "\""%>>Next >></a></td></tr>
						</table>
						<center>
						...
						<label>Description Of Species</label> <a href=<%="\"Descrip.jsp?name=" + blist.getSpecies_ID() + "\""%> >Click Here</a>  
