				...
				<col width="300">
					<tr>
						<th bgcolor="#000000"><center>
								<font size="3px" color="#ffffff">Common Name</font>
							</center></th>
						<th bgcolor="#000000"><center>
								<font size="3px" color="#ffffff">Species Name</font>
							</center></th>
					</tr>
					...
					List<BirdSpecies> BirdList=null;
					%>
					<%
						GetBirdSpecies bird = new GetBirdSpecies();
						 if(bird.getSpeciesUseSPName(val).isEmpty()){
							 BirdList=bird.getSpeciesComm2(val);
						 }
						 else{
							 BirdList=bird.getSpeciesUseSPName(val);
						 }
						for (BirdSpecies bs : BirdList) {
					%>
					<tr>

						<td bgcolor="#b0b0b0" align="center"><a
								href=<%="\"limage.jsp?name=" + bs.getSpecies_ID()+"-"+"0"+"\""%>><font size="2px" color="#000000"><%=bs.getCommon_Name() %></font></td>
						<td bgcolor="#b0b0b0" align="center"><a
								href=<%="\"limage.jsp?name=" +bs.getSpecies_ID()+"-"+"0"+ "\""%>><font size="2px" color="#000000"><%=bs.getSpecies_Name() %></a></font></td>
					</tr>
					<%
						}
					%>
