					...
					<div class="panel-body">
						<center>
							<table >
								...
								<col width="350">
									<tr>
									<th bgcolor="#000000"><font color="#ffffff"><center>Photographer</center></font></th>
										<th bgcolor="#000000"><font color="#ffffff"><center>Name</center></font></th>
										<th bgcolor="#000000"><font color="#ffffff"><center>Email</center></font></th>
										
									</tr>
								</thead>
								<%
									GetPhotographer photographer = new GetPhotographer();
									List<Photographer> PGList = photographer.getPhotographerList();
									for (Photographer pg : PGList) {
								%>
								<tbody>
									<tr>
									<td style="height: 100px;"><center>
												<a href=<%="\"Pimage.jsp?name=" +pg.getPhotographer_ID() +"\""%>><img src="<%=pg.getImg_URL()%>" class="img-thumbnail" width="60%" height="60%"></a>
											</center></td>
										<td><%=pg.getPhotographer_Name()%></td>
										<td><%=pg.getPhotographer_Email()%></td>
										<td><a href=<%="\"PGImages.jsp?name=" +pg.getPhotographer_ID() + "-"+"0"+"\""%>>All Images</a></td>
