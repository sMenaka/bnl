 ...
 %>
		...
		<div class="col-sm-7"
			...
			<table>
				<col width="600">
				<tr>
					<td bgcolor="#020202"><font color="#ffffff" size="3"><i><%=spName%></i>&nbsp;<%=commName%></font></td>
				</tr>
				<tr>
					<td >
					<audio id="bflat"> </audio>
			<button onclick="PlaySound()" class="btn btn-primary btn-lg">Bird
				Sound</button></td>
				</tr>
			</table>
		</div>
		<div class="col-sm-3"
			style="background-color: #014712; height: 550px;"></div>
	</div>
